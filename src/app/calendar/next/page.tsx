...
export default async function NextMatchdayPage() {
  ...
  const [
    ...
    supabase.from("leagues").select("id, name, football_data_code").eq("active", true),
  ]);
  ...
  return (
    <main className="mx-auto w-full max-w-3xl flex-1 p-6">
      <div className="mb-6 flex items-center justify-between">
        <h1 className="text-3xl font-bold">Prochaine journée</h1>
